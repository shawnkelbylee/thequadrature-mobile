...
window.injectUniversalUI = function() {
    ...
    style.innerHTML = `
        ...
        .q-global-controls { position: fixed; ${isHome ? 'display: none !important;' : 'bottom: calc(2.5vh + 60px);'} left: 50%; transform: translateX(-50%); z-index: 9995; background: rgba(10, 12, 18, 0.95); backdrop-filter: blur(20px); padding: 10px 25px; box-shadow: 0 10px 40px rgba(0,0,0,0.9), 0 0 20px rgba(255,255,255,0.05); border: 1px solid rgba(255, 255, 255, 0.1); pointer-events: auto; }
    ...
    uiWrapper.innerHTML = `
        ...
        <div class="q-global-controls q-scrubber-panel" id="q-universal-controls">
